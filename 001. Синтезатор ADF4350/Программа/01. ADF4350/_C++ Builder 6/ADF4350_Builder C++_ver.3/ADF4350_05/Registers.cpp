...
void __fastcall TForm9::UpdateCanvas(int Reg0, int Reg1, int Reg2, int Reg3, int Reg4, int Reg5, int Reg6)
{
  ...
  */
  ...
  Image1->Canvas->Pen->Color=clMoneyGreen;  // цвет пера clMoneyGreen
  Image1->Canvas->Pen->Width=32;            // ширина прямоугольника 32 pix
  ...
  Image1->Canvas->Pen->Color=clBlack;       // цвет пера clBlack
  Image1->Canvas->Pen->Width=3;             // ширина прямоугольника 3 pix

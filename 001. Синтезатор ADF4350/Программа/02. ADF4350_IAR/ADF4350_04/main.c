...
*/
    ...
    unsigned char var;                       // маркер передачи на синтезатор и фильтры или на || линии
    ...
    if(var==0xAA)                            // если маркер передачи на синтезатор и фильтры
    {  
...
*/     
    ...
    if(var==0x55)                            // маркер передачи на || линии
    {  
      t_led_on  = (T_LED_ON/6);              // время подсвечивания
      LED_ON; 

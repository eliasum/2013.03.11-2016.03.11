object Main_Form: TMain_Form
  ...
  object GB_Invisible: TGroupBox
    Left = 464
    Top = 32
    Width = 145
    Height = 113
    Caption = #1053#1045' '#1057#1052#1054#1058#1056#1045#1058#1068'!!!'
    TabOrder = 10
    Visible = False
    object L_S: TLabel
      Left = 45
  ...
  object ToolBar1: TToolBar
    ...
    object TB_SaveTesting: TToolButton
      Left = 8
      Top = 2
      Hint = #1057#1086#1093#1088#1072#1085#1080#1090#1100' '#1092#1072#1081#1083' '#1076#1072#1085#1085#1099#1093'|'#1057#1086#1093#1088#1072#1085#1080#1090#1100' '#1092#1072#1081#1083' '#1076#1072#1085#1085#1099#1093
    ...
    object TB_LoadTesting: TToolButton
      Left = 39
      Top = 2
      Hint = #1047#1072#1075#1088#1091#1079#1080#1090#1100' '#1092#1072#1081#1083' '#1076#1072#1085#1085#1099#1093'|'#1047#1072#1075#1088#1091#1079#1080#1090#1100' '#1092#1072#1081#1083' '#1076#1072#1085#1085#1099#1093
  ...
  object MainMenu: TMainMenu
    ...
    object File: TMenuItem
      ...
      object SaveTst: TMenuItem
        Caption = #1057#1086#1093#1088#1072#1085#1080#1090#1100' '#1092#1072#1081#1083' .load'
        Hint = #1057#1086#1093#1088#1072#1085#1080#1090#1100' '#1092#1072#1081#1083' '#1076#1072#1085#1085#1099#1093'|'#1057#1086#1093#1088#1072#1085#1080#1090#1100' '#1092#1072#1081#1083' '#1076#1072#1085#1085#1099#1093
        OnClick = TB_SaveTestingClick
      end
      object N2: TMenuItem
      ...
      object LoadTst: TMenuItem
        Caption = #1054#1090#1082#1088#1099#1090#1100' '#1092#1072#1081#1083' .load'
        Hint = #1047#1072#1075#1088#1091#1079#1080#1090#1100' '#1092#1072#1081#1083' '#1076#1072#1085#1085#1099#1093'|'#1047#1072#1075#1088#1091#1079#1080#1090#1100' '#1092#1072#1081#1083' '#1076#1072#1085#1085#1099#1093
        OnClick = TB_LoadTestingClick
      end
      object N3: TMenuItem

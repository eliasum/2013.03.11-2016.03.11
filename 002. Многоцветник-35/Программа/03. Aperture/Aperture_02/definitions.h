...
#define IN_SS0  PORTB0 // выход управления включением 1-го ведомого SPI                                    OUT (1)
...
#define IN_SS1  PORTB4 // выход управления включением 2-го ведомого SPI                                    OUT (1)
#define IN_SS2  PORTB5 // выход управления включением 3-го ведомого SPI                                    OUT (1)
#define IN_LE   PORTB6 // выход разрешения защёлки в последовательном режиме (Latch Enable in Serial Mode) OUT (1)
...
#define ADLIN1_D0 PORTE2 // выход на разъём XP2 PLS1.27 через буфер по питанию +5V/+5V D7 74ACT16244DL OUT (0)
#define ADLIN1_D1 PORTE3 // выход на разъём XP2 PLS1.27 через буфер по питанию +5V/+5V D7 74ACT16244DL OUT (0)
#define ADLIN1_D2 PORTE4 // выход на разъём XP2 PLS1.27 через буфер по питанию +5V/+5V D7 74ACT16244DL OUT (0)
#define ADLIN1_D3 PORTE5 // выход на разъём XP2 PLS1.27 через буфер по питанию +5V/+5V D7 74ACT16244DL OUT (0)
#define ADLIN1_D4 PORTE6 // выход на разъём XP2 PLS1.27 через буфер по питанию +5V/+5V D7 74ACT16244DL OUT (0)
#define ADLIN1_D5 PORTE7 // выход на разъём XP2 PLS1.27 через буфер по питанию +5V/+5V D7 74ACT16244DL OUT (0)

// определения выводов порта F
#define ADLIN1_D6 PORTF0 // выход на разъём XP2 PLS1.27 через буфер по питанию +5V/+5V D7 74ACT16244DL OUT (0)
...
#define IN3_08 PORTJ7 // выход на разъём XP5 PLS1.27 через буфер по питанию +5V/+3.3V D4 SN74ALVC164245DL OUT (0)

// определения выводов порта K
#define IN3_09 PORTK0 // выход на разъём XP5 PLS1.27 через буфер по питанию +5V/+3.3V D4 SN74ALVC164245DL OUT (0)
#define IN3_10 PORTK1 // выход на разъём XP5 PLS1.27 через буфер по питанию +5V/+3.3V D4 SN74ALVC164245DL OUT (0)
#define IN3_11 PORTK2 // выход на разъём XP5 PLS1.27 через буфер по питанию +5V/+3.3V D4 SN74ALVC164245DL OUT (0)
#define IN3_12 PORTK3 // выход на разъём XP5 PLS1.27 через буфер по питанию +5V/+3.3V D4 SN74ALVC164245DL OUT (0)
#define IN3_13 PORTK4 // выход на разъём XP5 PLS1.27 через буфер по питанию +5V/+3.3V D4 SN74ALVC164245DL OUT (0)
#define IN3_14 PORTK5 // выход на разъём XP5 PLS1.27 через буфер по питанию +5V/+3.3V D4 SN74ALVC164245DL OUT (0)
#define IN3_15 PORTK6 // выход на разъём XP5 PLS1.27 через буфер по питанию +5V/+3.3V D4 SN74ALVC164245DL OUT (0)
#define IN3_16 PORTK7 // выход на разъём XP5 PLS1.27 через буфер по питанию +5V/+3.3V D4 SN74ALVC164245DL OUT (0)

...
#define BR2K4          57600  // скорость обмена 57600
...
#define T_LED_ON     (SYSTEM_TICK/12)      // время индикации обращения к устройству
#define START_TIM0   0x04                  // предварительный делитель F_CPU/256

#define SYSTEM_TICK 600            // частота переполнения таймера0 в Гц
#define KDEL 256                   // коэффициент предварительного делителя для формирования тактового сигнала Т0
#define CLKT0 (F_CPU/KDEL)         // частота тактового сигнала Т0
#define NTAKT (CLKT0/SYSTEM_TICK)  // количество тактов для переполнения Т0
#define RELOAD_TIM0 (256-NTAKT)    // константа перезагрузки 'TIM0'
/*
...
Поэтому для генератора F_CPU/256 = 62500 переполнение возникает с частотой 62500/256 = 244,14 Гц.
А для переполнения с частотой 600 Гц небходимо 62500/600 = 104 такта генератора.

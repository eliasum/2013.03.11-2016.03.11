object Main_Form: TMain_Form
  ...
  object PC_Main: TPageControl
    ...
    Width = 817
    Height = 392
    Hint = #1044#1072#1085#1085#1099#1077' sar '#8470'1|'#1044#1072#1085#1085#1099#1077' sar '#8470'1'
    ActivePage = RLS1
    ...
    object BT: TTabSheet
      ...
      object GroupBox1: TGroupBox
        ...
        Width = 169
        Height = 121
        Caption = #1056#1077#1076#1072#1082#1090#1080#1088#1086#1074#1072#1085#1080#1077' '#1076#1072#1085#1085#1099#1093' '#1041#1058
        TabOrder = 1
    ...
    object RLS1: TTabSheet
      ...
      object LV_Sar1: TListView
        ...
        Columns = <
          ...
          item
            Caption = #1053#1077#1089#1091#1097#1072#1103' '#1095#1072#1089#1090#1086#1090#1072' ['#1052#1075#1094']'
            Width = -2
            WidthType = (
              -2)
          end
      ...
      object GroupBox2: TGroupBox
        ...
        Width = 177
        Height = 81
        Caption = #1056#1077#1076#1072#1082#1090#1080#1088#1086#1074#1072#1085#1080#1077' '#1076#1072#1085#1085#1099#1093' sar '#8470'1'
        TabOrder = 1
      ...
      object GroupBox3: TGroupBox
        ...
        Width = 177
        Height = 81
        Caption = #1056#1077#1076#1072#1082#1090#1080#1088#1086#1074#1072#1085#1080#1077' '#1076#1072#1085#1085#1099#1093' sar '#8470'2'
        TabOrder = 4
      ...
      object LV_Sar2: TListView
        ...
        Columns = <
          item
            Caption = #1050#1091' '#1091#1089#1080#1083#1080#1090#1077#1083#1103' 1 ['#1076#1041']'
            Width = -2
            WidthType = (
              -2)
          end
          item
            Caption = #1050#1091' '#1091#1089#1080#1083#1080#1090#1077#1083#1103' 2 ['#1076#1041']'
            Width = -2
            WidthType = (
              -2)
          end
          item
            Caption = 'f '#1089#1088#1077#1079#1072' '#1092#1080#1083#1100#1090#1088#1072' 1 ['#1075#1088#1072#1076'.]'
            Width = -2
            WidthType = (
              -2)
          end
          item
            Caption = 'f '#1089#1088#1077#1079#1072' '#1092#1080#1083#1100#1090#1088#1072' 2 ['#1075#1088#1072#1076'.]'
            Width = -2
            WidthType = (
              -2)
          end
          item
            Caption = 'W'#1088#1072#1073'. '#1087#1088#1080#1105#1084#1085#1080#1082#1072
            Width = -2
            WidthType = (
              -2)
          end
          item
            Caption = 'W'#1088#1072#1073'. '#1087#1077#1088#1077#1076#1072#1090#1095#1080#1082#1072
            Width = 120
          end>
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText

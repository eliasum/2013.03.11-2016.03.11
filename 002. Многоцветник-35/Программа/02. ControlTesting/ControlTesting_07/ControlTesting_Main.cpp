...
double k2=0.487, k3=0.529, k4=0.56, k5=1;
...
void __fastcall TMain_Form::StartControl()
{
  ...
  for(int i=0; i<4; i++)
  {
    CommPort1->PutChar((char)Command1[i]); // CommPort1->PutChar((char)Command1[i]) или uart_puthex_byte((char)Command1[i])
  }
/*
...
void __fastcall TMain_Form::StopControl()
{
  ...
  for(int i=0; i<4; i++)
  {
    CommPort1->PutChar((char)Command2[i]); // CommPort1->PutChar((char)Command2[i]) или uart_puthex_byte((char)Command2[i])
  }
/*
  CommPort1->PutChar(0x0d);                // возврат каретки
  CommPort1->PutChar(0x0a);                // перевод на следующую строку
...
void __fastcall TMain_Form::StartTesting()
{
  ...
  for(int i=0; i<4; i++)
  {
    CommPort1->PutChar((char)Com1[i]); // CommPort1->PutChar((char)Com1[i]) или uart_puthex_byte((char)Com1[i])
  }
/*
  CommPort1->PutChar(0x0d);            // возврат каретки
  CommPort1->PutChar(0x0a);            // перевод на следующую строку
...
void __fastcall TMain_Form::StopTesting()
{
  ...
  for(int i=0; i<4; i++)
  {
    CommPort1->PutChar((char)Com2[i]); // CommPort1->PutChar((char)Com2[i]) или uart_puthex_byte((char)Com2[i])
  }
/*
  CommPort1->PutChar(0x0d);            // возврат каретки
  CommPort1->PutChar(0x0a);            // перевод на следующую строку
...
void __fastcall TMain_Form::ComPortTransmitter()
{
  ...
  {
    CommPort1->PutChar(0x55);                    // маркер передачи на контроллер

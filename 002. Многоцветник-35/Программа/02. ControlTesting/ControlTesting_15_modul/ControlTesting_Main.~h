...
__published:	// IDE-managed Components
  ...
  TGroupBox *GroupBox1;
  TCheckBox *ChB_Command8;
  TComboBox *CB_Command8;
  TGroupBox *GroupBox2;
  TCheckBox *ChB_Command9;
  TComboBox *CB_Command9;
  TLabel *Label7;
  TLabel *Label10;
  ...
  void __fastcall E_DelayChange(TObject *Sender);
  void __fastcall RB_5GHzClick(TObject *Sender);
  void __fastcall RB_8GHzClick(TObject *Sender);
  void __fastcall B_EnterDelayClick(TObject *Sender);
  void __fastcall CB_ShiftChange(TObject *Sender);
  void __fastcall CB_Shift_Change(TObject *Sender);
  void __fastcall E_NumbOfModsChange(TObject *Sender);
  void __fastcall E_NumbOfModsExit(TObject *Sender);
  void __fastcall CB_ModulusChange(TObject *Sender);
  void __fastcall E_NumbOfFreqChange(TObject *Sender);
  void __fastcall E_NumbOfFreqExit(TObject *Sender);
  void __fastcall CB_FrequencyChange(TObject *Sender);
  void __fastcall E_ModChange(TObject *Sender);
  void __fastcall E_ModExit(TObject *Sender);
  void __fastcall B_AvailableComClick(TObject *Sender);
  void __fastcall CB_Command8Change(TObject *Sender);
  void __fastcall CB_Command9Change(TObject *Sender);
...
public:		// User declarations
  ...
  void __fastcall TMain_Form::InitModulus(void);
  void __fastcall TMain_Form::ResetModulus(void);
  void __fastcall TMain_Form::InitFrequency(void);
  void __fastcall TMain_Form::ResetFrequency(void);

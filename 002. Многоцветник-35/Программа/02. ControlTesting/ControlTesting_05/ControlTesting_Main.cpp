...
// по изменении номера БТ
{
  ...
  Comm3=StrToInt(E_Command3_2->Text);                // записать значение в переменную
...
// по изменении номера БТ
{
  ...
  Comm3=StrToInt(E_Com3_2->Text);                   // записать значение в переменную
  Comm4=StrToInt(E_Com4->Text);                     // записать значение в переменную
  Comm5=StrToInt(E_Com5->Text);                     // записать значение в переменную
  // записать значения в массив:
  Com3[OldIndex][3]=Comm3&0xFF;
  Com4[OldIndex][3]=Comm4&0xFF;                     // мл. байт
  Com4[OldIndex][2]=(Comm4/256)&0xFF;               // ст. байт
  Com5[OldIndex][3]=Comm5&0xFF;                     // мл. байт
  Com5[OldIndex][2]=(Comm5/256)&0xFF;               // ст. байт

  OldIndex=i;                                       // сохранить текущий порядковый номер
  E_Com3_2->Text=IntToStr(Com3[i][3]);              // показать текущее значение
...
*/
      ...
      E_Command3_2->Text=Command3[OldIndex][3];                         // показать текущее значение
...
/*
      ...
      E_Com3_2->Text=Com3[OldIndex][3];                     // показать текущее значение
...
{
  int Comm3;
  if(E_Command3_2->Text=="") E_Command3_2->Text=0;
  Comm3=StrToInt(E_Command3_2->Text);                // записать значение в переменную
...
//---------------------------------------------------------------------------
void __fastcall TMain_Form::E_Com3_2Exit(TObject *Sender)
{
  bool b;
  int min=0;
  int max=255;
  ...
  if(b)
  {
    E_Com3_2->Text=RoundValue(delta,value);
    Com3[OldIndex][3]=StrToInt(E_Com3_2->Text);
  }
  else
  {
    E_Com3_2->SetFocus();
...
void __fastcall TMain_Form::E_Com3_2Change(TObject *Sender)
{
  int Comm3;
  if(E_Com3_2->Text=="") E_Com3_2->Text=0;
  Comm3=StrToInt(E_Com3_2->Text);                // записать значение в переменную
  Com3[OldIndex][3]=Comm3&0xFF;                  // мл. байт
}
//---------------------------------------------------------------------------

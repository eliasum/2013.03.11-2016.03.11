...
//---------------------------------------------------------------------------
void __fastcall TMain_Form::cbLCnBTClick(TObject *Sender)
{
  cbLCnBT->Color=clWindow;
}
//---------------------------------------------------------------------------
...
{
  edLCBT->Color=clWindow;
  cbLCnBT->Color=clYellow;
}
//---------------------------------------------------------------------------
void __fastcall TMain_Form::E_TransClick(TObject *Sender)
{
  E_Trans->Color=clWindow;
  edLCBT->Color=clYellow;
}
//---------------------------------------------------------------------------
void __fastcall TMain_Form::E_TransMouseDown(TObject *Sender, TMouseButton Button,
          TShiftState Shift, int X, int Y)
{
  E_Trans->Color=clWindow;
  edLCBT->Color=clYellow;
...
//---------------------------------------------------------------------------
void __fastcall TMain_Form::cbLCnBTMouseEnter(TObject *Sender)
{
  cbLCnBT->Color=clWindow;
}
//---------------------------------------------------------------------------

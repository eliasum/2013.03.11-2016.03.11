...
// размещённые на форме компоненты
  ...
  void __fastcall BitBtn2Click(TObject *Sender);
	...
	void __fastcall cbLCnBTClick(TObject *Sender);
	void __fastcall edLCBTClick(TObject *Sender);
	void __fastcall E_TransClick(TObject *Sender);
	void __fastcall E_TransMouseDown(TObject *Sender, TMouseButton Button, TShiftState Shift,
          int X, int Y);
	void __fastcall cbLCnBTMouseEnter(TObject *Sender);

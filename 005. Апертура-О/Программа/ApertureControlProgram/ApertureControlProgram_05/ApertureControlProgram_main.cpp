...
float Ip27BDminD34=-15;
float Ip27BDmaxD34=15;
...
*/
	...
	if(range==D3)
	  if((ValuePo>1.39)||(ValuePo<=1.33))
		goto Lab1;

	if(range==D2)
	  if((ValuePo>1.33)||(ValuePo<=1.25))
		goto Lab1;

	if(range==D4)
	  if((ValuePo>1.48)||(ValuePo<=1.39))
		goto Lab1;
...
*/
	...
	if(range==D3)
	  if((ValuePr>1.39)||(ValuePr<=1.33))
		goto Lab3;

	if(range==D2)
	  if((ValuePr>1.33)||(ValuePr<=1.25))
		goto Lab3;

	if(range==D4)
	  if((ValuePr>1.48)||(ValuePr<=1.39))
		goto Lab3;

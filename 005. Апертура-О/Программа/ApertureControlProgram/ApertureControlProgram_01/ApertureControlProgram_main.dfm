  ...
  object PC_Main: TPageControl
    ...
    object Sar_invisible: TTabSheet
      ...
      object LE_A: TLabeledEdit
        ...
        EditLabel.Height = 13
        EditLabel.BiDiMode = bdRightToLeftNoAlign
        EditLabel.Caption = #1055#1086#1083#1086#1078#1077#1085#1080#1077' '#1072#1085#1090#1077#1085#1085' '#1056#1057#1040' ['#1075#1088#1072#1076'.]'
        EditLabel.ParentBiDiMode = False
        TabOrder = 3
        Text = '0'
      end
    ...
    object Tsh_Testing: TTabSheet
      ...
      object ScrollBox1: TScrollBox
        ...
        object GroupBox30: TGroupBox
          ...
          Width = 561
          Height = 57
          Caption = #1050#1086#1084#1072#1085#1076#1072' "'#1042#1082#1083#1102#1095#1080#1090#1100' +20 '#1042' '#1085#1072' '#1074#1099#1085#1086#1089#1085#1086#1084' '#1087#1077#1088#1077#1076#1072#1090#1095#1080#1082#1077'"'
          TabOrder = 0
        ...
        object GroupBox31: TGroupBox
          ...
          Width = 561
          Height = 57
          Caption = #1050#1086#1084#1072#1085#1076#1072' "'#1042#1082#1083#1102#1095#1080#1090#1100' -8 '#1042' '#1085#1072' '#1074#1099#1085#1086#1089#1085#1086#1084' '#1087#1077#1088#1077#1076#1072#1090#1095#1080#1082#1077'"'
          TabOrder = 1
        ...
        object GroupBox32: TGroupBox
          ...
          Width = 561
          Height = 57
          Caption = #1050#1086#1084#1072#1085#1076#1072' "'#1042#1082#1083#1102#1095#1080#1090#1100' +12 '#1042' '#1085#1072' '#1074#1099#1085#1086#1089#1085#1086#1084' '#1087#1077#1088#1077#1076#1072#1090#1095#1080#1082#1077'"'
          TabOrder = 2
        ...
        object GroupBox33: TGroupBox
          ...
          Width = 561
          Height = 57
          Caption = #1050#1086#1084#1072#1085#1076#1072' "'#1042#1082#1083#1102#1095#1080#1090#1100' +12 '#1042' '#1085#1072' '#1074#1099#1085#1086#1089#1085#1086#1084' '#1087#1088#1080#1077#1084#1085#1080#1082#1077'"'
          TabOrder = 3
    ...
    object TSh_Service: TTabSheet
      ...
      object PC_Service: TPageControl
        ...
        object h_FRLP_Testing: TTabSheet
          Caption = #1060#1056#1051#1055', '#1058#1077#1089#1090'.'
          ImageIndex = 2
        end
        object TSh_PRM: TTabSheet
          Caption = #1055#1056#1052
          ImageIndex = 3
        end
        object TSh_PRD: TTabSheet

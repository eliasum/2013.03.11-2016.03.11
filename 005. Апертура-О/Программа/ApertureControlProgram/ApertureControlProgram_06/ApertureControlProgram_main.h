...
__published:	// IDE-managed Components
	...
	TTimer *WorkTimer;
	TGroupBox *GroupBox1;
	TComboBox *CB_Att_PRM;
	TGroupBox *GroupBox2;
	TComboBox *CB_Att_PRD;
	TGroupBox *GroupBox3;
	TComboBox *CB_FreqRange;
	TButton *Button1;
	TGroupBox *GroupBox5;
	...
	TComboBox *CB_Att_BSR;
	TGroupBox *GroupBox13;
	TCheckBox *CheckBox14;
	TRadioButton *RB_ReceiverHet;
	TRadioButton *RB_TransmitHet;
	TGroupBox *GroupBox14;
	TCheckBox *CheckBox15;
	TRadioButton *RB_ReceiverHetR;
	TRadioButton *RB_TransmitHetR;
	...
	void __fastcall T_Sec1Timer(TObject *Sender);
	void __fastcall T_Sec2Timer(TObject *Sender);
	void __fastcall T_mSec1Timer(TObject *Sender);
	void __fastcall CB_FreqRangeChange(TObject *Sender);
	void __fastcall CB_FreqRangeExit(TObject *Sender);
	void __fastcall NIDAQmxTimerTimer(TObject *Sender);
	void __fastcall CB_Command6Change(TObject *Sender);
	void __fastcall CB_Command6Exit(TObject *Sender);
	...
	void __fastcall CB_Com21Change(TObject *Sender);
	void __fastcall CB_Com22Change(TObject *Sender);
	void __fastcall T_Sec3Timer(TObject *Sender);
	void __fastcall T_mSec2Timer(TObject *Sender);
	void __fastcall CB_AllCom_Click(TObject *Sender);
	void __fastcall Button2Click(TObject *Sender);
	void __fastcall T_mSec3Timer(TObject *Sender);
	void __fastcall T_Sec4Timer(TObject *Sender);
	void __fastcall T_Sec5Timer(TObject *Sender);
	void __fastcall T_Sec35Timer(TObject *Sender);
	void __fastcall T_Sec45Timer(TObject *Sender);
...
public:		// User declarations
	...
	void __fastcall TMainForm::Bin_to_dec (unsigned char s[], signed int dnum);
	...
	void __fastcall TMainForm::SetFRLP(void);
	AnsiString __fastcall TMainForm::IntToHexStr(unsigned int v);
	void __fastcall TMainForm::VIPWorkON(void);
	void __fastcall TMainForm::VIPWorkOFF(void);

...
__published:	// IDE-managed Components
	...
	void __fastcall ST_EmailMouseDown(TObject *Sender, TMouseButton Button, TShiftState Shift,
          int X, int Y);
	void __fastcall ST_EmailMouseUp(TObject *Sender, TMouseButton Button, TShiftState Shift,
          int X, int Y);

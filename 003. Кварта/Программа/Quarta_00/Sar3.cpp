...
{
  UpdateSar3();        // обновление значений данных  
}
//---------------------------------------------------------------------------
...
void __fastcall TF_Sar3::FormShow(TObject *Sender)
{
  ...
  {
    InpStr1=IntToHex(0, 2);  // при открытии формы сделать копию текущего значения
...
//---------------------------------------------------------------------------
void __fastcall TF_Sar3::UpdateSar3(void)  // обновление значений данных
{
